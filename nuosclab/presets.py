...
MicroBooNE = ExperimentPreset("MicroBooNE", L_km=0.470, rho_gcc=1.4, E_range=(0.1, 2.0), E_peak=0.8)

PRESETS: dict[str, ExperimentPreset] = {p.name: p for p in (NOVA, DUNE, T2K, MicroBooNE)}
